...
func (c *mlbChartConfig) patchToChartValues(crdConfig *metallbv1beta1.MetalLB, withPrometheus bool, valueMap map[string]interface{}) {
	c.withGeneralValues(crdConfig, valueMap)
	c.withPrometheusValues(valueMap)
	c.withControllerValues(crdConfig, valueMap)
	c.withSpeakerValues(crdConfig, valueMap)
}

func (c *mlbChartConfig) withGeneralValues(crdConfig *metallbv1beta1.MetalLB, valueMap map[string]interface{}) {
	if crdConfig.Spec.LoadBalancerClass != "" {
		valueMap["loadBalancerClass"] = crdConfig.Spec.LoadBalancerClass
	}
}

func (c *mlbChartConfig) withPrometheusValues(valueMap map[string]interface{}) {
...
func (c *mlbChartConfig) withControllerValues(crdConfig *metallbv1beta1.MetalLB, valueMap map[string]interface{}) {
...
func (c *mlbChartConfig) withSpeakerValues(crdConfig *metallbv1beta1.MetalLB, valueMap map[string]interface{}) {
